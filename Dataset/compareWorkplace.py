...
# # Group data by quarter and sum vacancies
# df_workplaces_grouped = df_workplaces.groupby(['Quarter', 'Workplace']).sum().reset_index()
...
#     y='VacancyCount',
#     color='Workplace',
#     tooltip=['Quarter', 'Workplace', 'VacancyCount',]).properties(
